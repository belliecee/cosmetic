...
class user extends beforeSaveActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, givenname, lastname, email, username, password, auth, birthdate, registereddate, updatedate, last_time_login, sex, income, occupation, skin, otherskin, facebook, googleplus, address, greeting, mobile', 'safe', 'on'=>'search'),
		);
	}
