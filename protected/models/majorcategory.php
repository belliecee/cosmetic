...
/**
 * This is the model class for table "majorcategory".
 *
 * The followings are the available columns in table 'majorcategory':
 * @property string $id
 ...
 */
class majorcategory extends beforeSaveActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return majorcategory the static model class
	 */
