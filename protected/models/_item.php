...
class item extends beforeSaveActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('create_on, makerComment, usage, ingredient, remark, update_on', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, name, image, brand, category, reviewNum, avgVote, create_on, resultVote, marketPrice, maker, makerComment, usage, volume, ingredient, remark, facebookLike, tweet, googlePlus, create_by, update_on, update_by', 'safe', 'on'=>'search'),
		);
	}
