...
class review extends beforeSaveActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('comment, update_on', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, item_id, user_id, comment, vote, status, buyfrom, reviewvote, result, fblike, googleplus, update_on, update_by', 'safe', 'on'=>'search'),
		);
	}
