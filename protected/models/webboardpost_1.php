 ...
 */
class webboardpost extends beforeSaveActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, topic, detail, posting_datetime, type, link_id, status, voteNum, fblike, googleplus, tweet, update_on, update_by', 'safe', 'on'=>'search'),
		);
	}
