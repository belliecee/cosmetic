...
//  UPDATE SELECT      
?>                                                                                                                             <div id='<?php echo $_column['name']."_".$_model->id ;?>' class="td_select" style="max-width:<?php echo $_column['colwidth']; ?> ;width:100%" data-pk='<?php echo $_model->id; ?>' data-name='<?php echo $_column['name']; ?>'  data-type='<?php echo $_column['type'];  ?>' data-url='<?php echo $path;?>' data-value='<?php echo $_model->getAttribute($_column['name']);?>' data-colwidth ='<?php echo $_column['colwidth']; ?>' data-source ='<?php echo $_column['source']; ?>' >
