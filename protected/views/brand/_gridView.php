...
*/     
 ...
 <ul class="inline_view" style="float:right;margin-bottom:20px">
     <li style="width:60px;">
                                        ...
                                        <?php           
                                         ...
                                         <?php  
                                                              ...
                                                              if(isset($_column['relation'])){
                                                                   ...
                                                                   if($_column['type'] == 'image'){
                                                                         $dir = Yii::app()->baseUrl.'/brandimgs'; 
                                                                         if($_model->brand_img != null && $_model->brand_img != ""){ 
                                                                            $path = $dir.'/'.$_model->brand_img;     
?>                                                                           
                                                                            <img class="userdisplaypic_inside" src="<?php echo $path ;?>" style="border:1px rgb(217,217,217) solid;  width:130px;height:55px; background-size:100%;padding:0;margin-left:-1px;margin-top:-1px;margin-bottom: 20px; "  />
<?php                 
                                                                         }else{
                                                                             echo "No image";
                                                                         }
        ...
        ?>           
                   <td><center>
                          <?php 
                                  ...
                                  echo CHtml::link("<div class='update' style='width:20px !important'>&nbsp;</div>",array("brand/update",'id'=>$_model->id),array('style'=>'text-decoration: none'));
                          ?>
