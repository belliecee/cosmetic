...
<div class="view itemrow"  >
 ...
 <?php  $border_bottom = $dir.'/ranking_border-bottom.jpg'; ?>
    ...
    <div class="item_ranking" ><img src='<?php echo $border_top ; ?>'>No. <?php echo $data->currentRanking; ?><img src='<?php echo $border_bottom ; ?>'></div>
...
?>
                <div style="font-size:11px"> &nbsp;&nbsp;
                         <i class=" fa fa-quote-left ">&nbsp;&nbsp;</i><?php echo " จำนวนรีวิว " ; if($data->reviewNum == null || $data->reviewNum == ""){echo '0';}else{ echo $data->avgVote;} 
        ...
        <?php
               $listyle = "font-weight:bold;font-size:16px;list-style:none;cursor:pointer;margin-top:5px;";
               $stardir = Yii::app()->baseUrl.'/images';
               $margenta = "color:rgb(56,186,149); font-size:16px;";
...
<!--        <div style=" float:left;background-position:center;background-repeat:no-repeat;background-size: 25px 25px;background-image:url('<?php //echo $stardir.'/review.png'; ?>') ;  width:30px;height:30px"></div>-->
                  <li style=<?php echo $listyle.$margenta; ?>> <i class=" fa fa-comment-o"></i> &nbsp;&nbsp;<a href="<?php echo $toreview; ?>"><div  class="paneltext" style="font-size:12px;margin-top:5px;vertical-align:text-top;height: 100%;display: inline-block; ">เขียน Review</div></a> </li>
