...
$form = $this->beginWidget('bootstrap.widgets.TbActiveForm', array(
        ...
        'action' => $this->createUrl('review/create',array('itemid'=>$itemid,'userid'=>$userid)),
...
<?php // Comment ?> 
  ...
  */
    ...
    $backto = $this->createUrl('item/view',array('id'=>$itemid));
    ?>
  <style>
      a:hover{
...
<div class="row_action">  
    <a href='<?php echo $backto ?>' class="btn btn-danger submit"><i class="icon-white icon-arrow-left"></i> ย้อนกลับ</a>
 
   <button class="btn btn-primary" style="margin-left: 30px;"><i class="icon-pink icon-ok-sign"></i> โพสต์รีวิวนี้</button>
</div>  
