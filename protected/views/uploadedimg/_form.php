...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'imgtype'); ?>
		<?php echo $form->textField($model,'imgtype',array('size'=>60,'maxlength'=>128)); ?>
		<?php echo $form->error($model,'imgtype'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'imgcategory'); ?>
		<?php echo $form->textField($model,'imgcategory',array('size'=>60,'maxlength'=>128)); ?>
		<?php echo $form->error($model,'imgcategory'); ?>
	</div>
